...
def render(titulo, descricao, corpo_html, css=BASE_CSS, analytics_snippet=""):
    return HTML_SHELL.format(
        titulo=titulo, descricao=descricao, corpo=corpo_html, css=css, analytics=analytics_snippet
    )
