...
# --------------------------------------------------------------------------
# Contagem de acessos (opcional)
# --------------------------------------------------------------------------
# Para contar quantos acessos cada card recebe (sem saber quem acessou),
# crie uma conta gratuita em https://www.goatcounter.com/ (ela leva menos de
# 1 minuto: só um e-mail e o "nome do site" que você quiser, ex: "vero-parceiros")
# e cole esse nome aqui embaixo. Deixe em branco ("") para não rastrear nada.
GOATCOUNTER_CODE = "vero-parceiros"  # ex: "vero-parceiros" (sem o .goatcounter.com)
